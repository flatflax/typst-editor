...
multiple pages — e.g. Phase 4's focus-reveals-source split mode, which has not yet been
verified against a multi-page document (a real, flagged risk — see
`doc/phase4-product-validation.md`).
